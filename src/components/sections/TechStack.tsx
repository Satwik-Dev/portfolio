...
const BRAND: Record<string, { color: string; abbr: string; draw?: string }> = {
  ...
  Java:             { color: '#ED8B00', abbr: 'Ja', draw: 'text' },
  JavaScript:       { color: '#F7DF1E', abbr: 'JS', draw: 'js' },
  TypeScript:       { color: '#3178C6', abbr: 'TS', draw: 'ts' },
  Ruby:             { color: '#CC342D', abbr: 'Rb', draw: 'text' },
  C:                { color: '#A8B9CC', abbr: 'C', draw: 'text' },
  'C++':            { color: '#00599C', abbr: 'C+', draw: 'text' },
  HTML:             { color: '#E34F26', abbr: 'HT', draw: 'text' },
  CSS:              { color: '#1572B6', abbr: 'CS', draw: 'text' },
  // Frontend
  'React.js':       { color: '#61DAFB', abbr: 'Re', draw: 'react' },
  ...
  Flask:            { color: '#000000', abbr: 'Fl', draw: 'text' },
  'Ruby on Rails':  { color: '#CC0000', abbr: 'RR', draw: 'text' },
  'RESTful API':    { color: '#6BA539', abbr: 'RS', draw: 'text' },
  // Databases
  PostgreSQL:       { color: '#336791', abbr: 'PG', draw: 'pg' },
  Redis:            { color: '#DC382D', abbr: 'Rd', draw: 'text' },
  MongoDB:          { color: '#47A248', abbr: 'Mo', draw: 'mongo' },
  Supabase:         { color: '#3ECF8E', abbr: 'Sb', draw: 'text' },
  // Cloud & DevOps
  Docker:           { color: '#2496ED', abbr: 'Dk', draw: 'text' },
  AWS:              { color: '#FF9900', abbr: 'AW', draw: 'text' },
  GCP:              { color: '#4285F4', abbr: 'GC', draw: 'text' },
  ...
  'VS Code':        { color: '#007ACC', abbr: 'VS', draw: 'text' },
  Figma:            { color: '#F24E1E', abbr: 'Fg', draw: 'text' },
  Postman:          { color: '#FF6C37', abbr: 'Pm', draw: 'text' },
  // AI & Data
  LLMs:             { color: '#8B5CF6', abbr: 'AI', draw: 'text' },
